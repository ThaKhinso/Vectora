...
namespace Vectora {
	...
	void EditorLayer::OnUpdate(Timestep ts)
	{
		...
		Renderer2D::DrawLine({ 0.0f, 0.0f, 1.f }, { 50.0f, 50.0f, 1.f}, { 1.0f, 0.0f, 1.0f, 1.0f });*/
	...
	{
		bool control = Input::IsKeyPressed(Key::VE_KEY_LEFT_CONTROL) || Input::IsKeyPressed(Key::VE_KEY_RIGHT_CONTROL);
		bool shift = Input::IsKeyPressed(Key::VE_KEY_LEFT_SHIFT) || Input::IsKeyPressed(Key::VE_KEY_RIGHT_SHIFT);
		switch (e.GetKeyCode())
		{
			case Key::VE_KEY_N:
			{
	...
	{
		if (e.GetMouseButton() == Key::VE_MOUSE_BUTTON_LEFT)
		{
			if (m_ViewportHovered && !ImGuizmo::IsOver() && !Input::IsKeyPressed(Key::VE_KEY_LEFT_ALT))
	...
	void EditorLayer::OnOverlayRender()
	{
		...
		if (m_ShowPhysicsColliders)
		{
			...
			// Circle Colliders
			{
				...
				view.each([](auto entity, auto& tc, auto& cc2d)
					{
