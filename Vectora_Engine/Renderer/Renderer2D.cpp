...
namespace Vectora {
	...
	void Renderer2D::Init()
	{
		...
		VE_UINT32* quadIndices = new VE_UINT32[s_Data.MaxIndices];
		...
		VE_INT32 samplers[s_Data.MaxTextureSlots];
		for (VE_UINT32 i = 0; i < s_Data.MaxTextureSlots; i++)
			samplers[i] = i;

		s_Data.QuadShader = Shader::Create("shaders/Renderer2D_Quad.vertex.glsl", "shaders/Renderer2D_Quad.fragment.glsl");
		s_Data.QuadShader->Bind();
		s_Data.QuadShader->setInt("u_Texture", 0);
		s_Data.QuadShader->SetIntArray("u_Textures", samplers, s_Data.MaxTextureSlots);

		s_Data.CircleShader = Shader::Create("shaders/Renderer2D_Circle.vertex.glsl", "shaders/Renderer2D_Circle.fragment.glsl");
		s_Data.LineShader = Shader::Create("shaders/Renderer2D_Line.vertex.glsl", "shaders/Renderer2D_Line.fragment.glsl");
